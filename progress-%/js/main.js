( function( $ ) {
    ...
    /* circle */
                // Get a reference to the "myhide" element
const myhide = document.getElementById('myhide');

// // Get a reference to the search box element
 const searchBox = document.querySelector('.search-box');

// // Add a mouseover event listener to "myhide"
 myhide.addEventListener('mouseover', function() {
//   // Show the search box
  searchBox.style.visibility = 'visible';
});

// // Add a mouseout event listener to "myhide"
myhide.addEventListener('mouseout', function() {
//   // Hide the search box
...
// 2nd box
            // Get a reference to the "myhide" element
const myhide2 = document.getElementById('myhide2');

// // Get a reference to the search box element
 const searchBox2 = document.querySelector('.search-box2');

// // Add a mouseover event listener to "myhide"
 myhide2.addEventListener('mouseover', function() {
//   // Show the search box
  searchBox2.style.visibility = 'visible';
});

// // Add a mouseout event listener to "myhide"
myhide2.addEventListener('mouseout', function() {
//   // Hide the search box
...
// 3nd box
            // Get a reference to the "myhide" element
            const myhide3 = document.getElementById('myhide3');

// // Get a reference to the search box element
 const searchBox3 = document.querySelector('.search-box3');

// // Add a mouseover event listener to "myhide"
 myhide3.addEventListener('mouseover', function() {
//   // Show the search box
  searchBox3.style.visibility = 'visible';
});

// // Add a mouseout event listener to "myhide"
myhide3.addEventListener('mouseout', function() {
//   // Hide the search box
...
// 4nd box
            // Get a reference to the "myhide" element
            const myhide4 = document.getElementById('myhide4');

// // Get a reference to the search box element
 const searchBox4 = document.querySelector('.search-box4');

// // Add a mouseover event listener to "myhide"
 myhide4.addEventListener('mouseover', function() {
//   // Show the search box
  searchBox4.style.visibility = 'visible';
});

// // Add a mouseout event listener to "myhide"
myhide4.addEventListener('mouseout', function() {
//   // Hide the search box
...
// 5nd box
            // Get a reference to the "myhide" element
            const myhide5 = document.getElementById('myhide5');

// // Get a reference to the search box element
 const searchBox5 = document.querySelector('.search-box5');

// // Add a mouseover event listener to "myhide"
 myhide5.addEventListener('mouseover', function() {
//   // Show the search box
  searchBox5.style.visibility = 'visible';
});

// // Add a mouseout event listener to "myhide"
myhide5.addEventListener('mouseout', function() {
//   // Hide the search box
  searchBox5 .style.visibility = 'hidden';
});

// 6nd box
            // Get a reference to the "myhide" element
            const myhide6 = document.getElementById('myhide6');

// // Get a reference to the search box element
 const searchBox6 = document.querySelector('.search-box6');

// // Add a mouseover event listener to "myhide"
 myhide6.addEventListener('mouseover', function() {
//   // Show the search box
  searchBox6.style.visibility = 'visible';
});

// // Add a mouseout event listener to "myhide"
myhide6.addEventListener('mouseout', function() {
//   // Hide the search box
  searchBox6.style.visibility = 'hidden';
});
